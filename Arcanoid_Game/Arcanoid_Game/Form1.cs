...
namespace Arcanoid_Game
{
    public partial class Form1 : Form
    {
        ...
        public void Init()
        {
            ...
            arcanoidSet = new Bitmap("C:\\Users\\unico\\Desktop\\Диана за рулем\\Arcanoid_Game-Vagapov\\Arcanoid_Game\\Image\\arcanoid.png");
            timer1.Interval = 200;
        ...
        {
            // Сброс координат предыдущего шара
            map[ballY, ballX] = 0;
            ...
            // Установка новых координат для нового шара
            map[ballY, ballX] = 8;
